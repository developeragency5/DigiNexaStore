...
Service Providers — With third-party companies that help us operate AppVault (e.g., hosting, analytics, email delivery). These parties are bound by confidentiality obligations.
...
AppVault does not sell your personal information for monetary compensation.`,
  },
  {
...
To exercise any of these rights, contact us at hello@appvault.app.`,
  },
  {
    title: "9. International Data Transfers",
    body: `AppVault is operated from the United States. If you access AppVault from outside the United States, your information may be transferred to and processed in the United States or other countries where our service providers operate.
...
We take appropriate steps to ensure that any international transfers comply with applicable data protection laws, including using standard contractual clauses where required.`,
  ...
  {
    title: "10. Security",
    body: `We implement reasonable technical and organisational measures to protect your information from unauthorised access, disclosure, alteration, or destruction. However, no internet transmission is 100% secure. We cannot guarantee the absolute security of information transmitted to or from AppVault.

Please notify us immediately at hello@appvault.app if you become aware of any unauthorised access to your information.`,
  },
  {
    title: "11. Changes to This Policy",
    body: `We may update this Privacy Policy from time to time to reflect changes in our practices or applicable law. We will notify you of significant changes by posting a notice on our website or by updating the "Last Updated" date. Your continued use of AppVault after any changes constitutes your acceptance of the updated Policy.`,
  },
  {
    title: "12. Contact Us",
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <p className="text-gray-600 mt-4 leading-relaxed">
            AppVault ("we", "us", or "our") is committed to protecting your privacy. This Privacy Policy explains
