    ...
    >
      {isPlay ? (
        <svg className="h-7 w-7 shrink-0" viewBox="0 0 24 24" fill="currentColor">
          <path d="M22.018 13.298l-3.919 2.218-3.515-3.493 3.543-3.521 3.891 2.202a1.49 1.49 0 0 1 0 2.594zM1.337.924a1.486 1.486 0 0 0-.112.568v21.017c0 .217.045.419.124.6l11.155-11.087L1.337.924zm12.207 10.065l2.892-2.887L3.115.318A1.519 1.519 0 0 0 2.392.1L13.544 10.989zm0 2.067L2.463 23.988a1.5 1.5 0 0 0 .652-.134l13.32-7.568-2.888-2.835z"/>
        </svg>
      ) : (
        <svg className="h-7 w-7 shrink-0" viewBox="0 0 24 24" fill="currentColor">
