...
const highlights = [
  {
    icon: "🚫",
    title: "No Purchases on App US",
    body: "App US does not process any payments, subscriptions, or in-app purchases. No credit card or payment information is ever requested on this site.",
  },
  {
    icon: "🔗",
  ...
  {
    icon: "💰",
    title: "No Refunds via App US",
    body: "Because App US does not collect payment, we cannot process refunds. Refund requests must be submitted to Apple, Google, or the app developer directly.",
  },
  {
    icon: "🛡️",
    title: "You Are Never Charged by App US",
    body: "App US is entirely free to browse and search. We generate revenue through advertising, not from users. You will never receive a bill from App US.",
  },
];

const sections = [
  {
    title: "1. App US Is a Discovery Platform Only",
    body: `App US is a free, curated app and game discovery platform. Our sole purpose is to help you find the best iOS and Android apps and games.
...
All applications listed on App US are available exclusively through their respective official app store platforms.`,
  },
  {
    title: "2. Where Purchases Happen",
    body: `If an app listed on App US is paid or contains in-app purchases, those transactions take place entirely on the following third-party platforms:
...
App US has no involvement in, control over, or responsibility for transactions that occur on these platforms.`,
  },
  {
    title: "3. Pricing Information",
    body: `Pricing information displayed on App US (e.g., "Free", "£2.99", "Freemium") is sourced from publicly available data and is provided for general informational purposes only.

App pricing is set and controlled entirely by the app developer and/or the app store platform. Prices may vary by country, currency, or promotional period. App US does not guarantee the accuracy or currency of any pricing information.

Always verify the current price on the relevant app store before initiating a download or purchase.`,
  },
  {
    title: "4. Refund Policy",
    body: `Because App US does not process any payments, App US has no refund policy to offer. We are unable to process, authorise, or facilitate refunds of any kind.
...
For subscription or billing disputes with a specific app, you may also contact the developer directly using the contact information available on their app store listing.`,
  },
  {
    ...
    body: `As App US does not sell or distribute any physical or digital goods, there is no return policy applicable to anything accessed through App US.
...
Apps are digital goods delivered directly by third-party platforms. Returns, cancellations, and withdrawal rights for digital goods are governed by the policies of the relevant app store platform and applicable consumer law in your jurisdiction.`,
  ...
  {
    title: "6. Delivery",
    body: `App US does not deliver any products — physical or digital. There are no shipping charges, delivery timelines, or logistics of any kind associated with using App US.

When you follow a link from App US to an app store and download an app, that download is delivered and managed entirely by the app store platform. App US has no involvement in the download or installation process.`,
  },
  {
    title: "7. Subscription Services",
    body: `App US does not offer, manage, or bill any subscription services to users. If an app you discover on App US offers a subscription model, that subscription is managed directly by the app developer and/or the app store platform.
...
App US is not responsible for any subscription charges incurred via third-party apps.`,
  },
  {
...
If you believe a charge from App US has appeared on your statement, please contact us immediately at hello@App US.net — we take these reports seriously and will investigate. However, please be aware that App US does not charge users and a charge listed as "App US" on your statement is likely a case of mistaken identity or fraud unrelated to our platform.`,
  },
  {
    title: "9. Contact",
    body: `If you have questions about this policy or believe you were charged by App US in error:
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <p className="text-gray-600 leading-relaxed">
            App US does not sell, distribute, or charge for any app or game. This page makes
            crystal clear what App US is, what it is not, and where to direct refund or billing
            enquiries.
          </p>
        </div>
      </div>
