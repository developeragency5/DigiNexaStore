...
const cookieTypes = [
  ...
  },
  {
    ...
    desc: "These cookies help us understand how visitors interact with App US by collecting aggregated, anonymous statistics. We use this data to improve site performance and content. Individual users cannot be identified from this data.",
  ...
  },
  {
    ...
    desc: "App US uses advertising technology to serve interest-based advertisements and to measure the performance of advertising campaigns. These technologies may set cookies or use pixel tags on your device. This data may be shared with our digital advertising network partners to serve you relevant ads on App US and other sites across the internet. See our Advertising Disclosure for full details.",
...
• "First-party" cookies — set by App US directly
• "Third-party" cookies — set by our partners (analytics or advertising services)`,
  },
  {
    title: "How We Use Cookies",
    body: `App US uses cookies and similar technologies to:
...
If your browser sends a GPC signal, App US will treat it as a request to opt out of sharing for interest-based advertising.
...
By continuing to use App US without adjusting your cookie settings, you consent to our use of optional cookies. You may withdraw this consent at any time using the browser controls or opt-out tools described above.`,
  },
  {
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <p className="text-gray-600 mt-4 leading-relaxed">
            This Cookie Policy explains how App US uses cookies and similar tracking technologies when you visit our website.
