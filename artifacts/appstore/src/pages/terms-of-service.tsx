...
We reserve the right to modify these Terms at any time. We will notify you of material changes by posting a notice on our website or updating the "Last Updated" date. Your continued use of the Service after any changes constitutes your acceptance of the revised Terms.`,
  },
  {
    ...
    body: `AppVault is a curated app discovery platform that provides information about mobile applications and games for iOS and Android platforms. AppVault is a free discovery and information service only.

We do NOT:
• Distribute, host, sell, or license any application
• Process payments or collect financial information from users
• Charge users any fee for browsing, searching, or using AppVault

All apps are available exclusively through third-party app stores, including Google Play and the Apple App Store. AppVault provides links to these platforms for your convenience. We are not a party to any transaction between you and an app store or developer.`,
  },
  {
    title: "3. No Purchases on AppVault",
    body: `AppVault does not sell, distribute, or facilitate the purchase of any applications or in-app content. Any transaction you make after following a link from AppVault is governed entirely by the terms, policies, and payment systems of the relevant app store platform (Apple or Google) and/or the app developer.

AppVault has no responsibility for:
...
• Interfere with or disrupt the integrity or performance of the Service`,
  },
  {
    ...
    body: `All content on AppVault — including text, graphics, logos, the selection and arrangement of content, and underlying code — is owned by AppVault or its licensors and is protected by copyright, trademark, and other intellectual property laws.

App names, icons, screenshots, descriptions, and other materials displayed on AppVault are the intellectual property of their respective developers and are used for informational and editorial purposes only. AppVault claims no ownership over third-party intellectual property.

You may not reproduce, distribute, or create derivative works from AppVault content without our prior written consent.`,
  },
  {
    title: "6. Accuracy of Information",
    body: `We strive to keep app information accurate and current. However, AppVault makes no warranties or representations regarding the accuracy, completeness, or reliability of any app descriptions, ratings, pricing, or other information displayed on the Service.
...
App details such as pricing, availability, and features may change without notice. Always verify current information on the relevant official app store before downloading or purchasing any application. See our Disclaimer for further details.`,
  },
  {
    ...
    body: `AppVault contains links to third-party websites and app stores. These links are provided for convenience only. We have no control over the content, policies, or practices of third-party sites and accept no responsibility for them or for any loss or damage that may arise from your use of them.

The presence of a link on AppVault does not imply our endorsement of the linked site or its content.`,
  },
  {
    title: "8. Advertising",
    body: `AppVault displays digital advertisements, including interest-based advertisements served through third-party advertising networks. By using AppVault, you consent to the display of such advertising. For details on how advertising data is collected and how to opt out of interest-based advertising, see our Advertising Disclosure.`,
  },
  {
...
THIS LIMITATION APPLIES REGARDLESS OF THE LEGAL THEORY AND EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.`,
  },
  {
    ...
    body: `You agree to indemnify and hold harmless AppVault and its officers, directors, employees, and affiliates from and against any claims, liabilities, damages, losses, and expenses (including reasonable legal fees) arising from:
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <p className="text-gray-600 mt-4 leading-relaxed">
            Please read these Terms of Service carefully before using AppVault. They govern your use of our website
